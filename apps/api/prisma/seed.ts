...
const PERMISSIONS: Record<string, string> = {
  ...
  'loyalty.read': "View a customer's loyalty balance and history",
  'loyalty.redeem': "Redeem a customer's loyalty points",
  'loyalty.adjust': 'Award, correct or reverse loyalty points',
...
const ROLES: Record<string, { name: string; permissions: string[] }> = {
  ...
  CASHIER: {
    ...
    permissions: [
      ...
      'customer.read',
      'customer.manage',
      // The till reads a balance and redeems, but only a manager adjusts.
      'loyalty.read',
      'loyalty.redeem',
      'cash.read',
      'cash.manage',
