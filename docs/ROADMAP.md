...
**Web routes:** `/` (landing), `/login`, `/setup`, `/dashboard`, `/dashboard/menu`, `/dashboard/cash` (day close), `/dashboard/audit`, `/dashboard/pos`, `/dashboard/orders`, `/dashboard/customers`, `/dashboard/inventory`, `/dashboard/staff`, `/dashboard/kitchen`, `/dashboard/analytics`, `/dashboard/reports`, `/dashboard/ai`, `/dashboard/marketing`, `/join/[token]`.
...
Also: `refunds`, `cash_sessions`, `cash_movements`. Restaurant profile columns and `order_type` on orders.
